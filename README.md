...
1. **Clone the repository**
   ```bash
   git clone https://github.com/lavudyaraja/Machine-learning-platform.git
   cd framework-setup
   ```
...
- 🐛 Issues: [GitHub Issues](https://github.com/lavudyaraja/Machine-learning-platform/issues)
