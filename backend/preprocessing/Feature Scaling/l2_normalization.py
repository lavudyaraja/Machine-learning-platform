...
Applies L2 normalization (Euclidean norm) to numerical columns.
"""
...
def apply_l2_normalization(
    ...
    **kwargs
    ...
    """
    Apply L2 normalization to numerical columns.
    Scales each row so that the Euclidean norm equals 1.
    ...
    for col in normalized_columns:
        scalers[col] = {
            "norm": "l2",
            "description": "Euclidean norm per row = 1"
        }
